...
function vecPetalArray = createErrorProfileV1_image(r, Profile, occulterDiameter, petalLength, numPetals, errorArray)
...
[petalX, petalY] = makePolygon_image(Profile, r, maxR, numPetals, 0, a, 3); % Get one petal edge
petalX = petalX(:).';
petalY = petalY(:).';
